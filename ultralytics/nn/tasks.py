...
class BaseModel(nn.Module):
    ...
    def _predict_once(self, x, profile=False, visualize=False, embed=None):
        ...
        for i, m in enumerate(self.model):
            ...
            # Handle predictive layers
            if isinstance(m, (C3GhostPredictive, SPPFPredictive, GhostConvPredictive, GhostBottleneckPredictive)):
                x = m(x, f"layer_{i}")  # Pass unique identifier
            else:
                x = m(x)  # run normal forward
